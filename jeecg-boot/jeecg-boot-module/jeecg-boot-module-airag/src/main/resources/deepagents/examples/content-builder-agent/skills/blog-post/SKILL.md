...
3. Example:
   ...
   ```
4. After research completes, read the findings file before writing
...
2. Generate a cover image using the `generate_cover` tool and save it to `blogs/<slug>/hero.png`
