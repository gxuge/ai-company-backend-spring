 ...
 * @date 2026/7/29
 */
public final class StoryConfirmationTransitions {
    public static final String ACCEPT_AND_CONTINUE = "ACCEPT_AND_CONTINUE";
    public static final String REGENERATE = "REGENERATE";
    public static final String ATTR_CONFIRMATION_DECISION = "storyConfirmationDecision";
    ...
    private StoryConfirmationTransitions() {
    }

    /**
     * 将前端确认选项转换为仅供故事 Agent 判断的内部状态。
     *
