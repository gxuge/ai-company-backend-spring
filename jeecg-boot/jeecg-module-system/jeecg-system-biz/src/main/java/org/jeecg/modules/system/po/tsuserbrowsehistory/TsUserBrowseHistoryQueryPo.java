package org.jeecg.modules.system.po.tsuserbrowsehistory;
 ...
 */
@Data
public class TsUserBrowseHistoryQueryPo {
     ...
     * @return 持久化查询参数
     */
    public static TsUserBrowseHistoryQueryPo fromRequest(String userId, TsUserBrowseHistoryQueryDto request) {
        TsUserBrowseHistoryQueryPo po = new TsUserBrowseHistoryQueryPo();
        po.setUserId(userId);
        if (request == null) {
